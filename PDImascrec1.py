...
def cargarImagen():
    ...
    if filename:
        ...
        setPhoto(imagen)
        cantidad_rectangulos, imagen_con_rectangulos = detectarRectangulos(imagen)
        print("Cantidad de rectángulos detectados:", cantidad_rectangulos)
...
def detectarRectangulos(image):
    ...
    return cantidad_rectangulos, image
